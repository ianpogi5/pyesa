  ...
  return (
    <div className="kantada">
      ...
      <p>
        ...
        sumakop sa akin. Pinagsisisihan kong masakit sa tanang loob ko ang lahat
        ng pagkakasala ko sa iyo, na Ikaw nga ang Diyos ko, Panginoon ko at Ama
        ko na iniibig ko nang higit sa lahat.
      </p>
      <p>
        Nagtitika akong matibay na matibay na di na muling magkakasala sa Iyo at
        magsisikap na magkumpisal ng lahat ng kasalanan ko. Umaasa akong
        patatawarin mo rin alang-alang sa Iyong mahal na Pasyon at pagkamatay Mo
      ...
      <p>
        (4) Hesus ko, alang-alang sa koronang tinik na tumimo sa kabanal-banalan
        mong ulo.
      </p>
      <p>
        (5) Hesus ko, alang-alang sa paglakad mo sa lansangan ng kapaitan na ang
        krus ay iyong pinapasan.
      </p>
      <p>
      ...
      <p>
        (9) Hesus ko, alang-alang sa Iyong kamahal-mahalang mga paa at kamay na
        pinaglagusan ng mga pakong ipinagdalita mong masakit.
      </p>
      <p>
        (10) Hesus ko, alang-alang sa tagiliran mong nabuksan sa saksak ng isang
      ...
      <p>
        ...
        templo, sa pagtutuwid mong ito, ikaw ay kanilang kinapootan, inalipusta
        ng mga hudyo, ikaw ay napasakamay nila dahil sa pagtataksil at paghalik
        ni Hudas, ginapos ka ng lubid at nilapastangan sa harap nila Anas,
        Pilato, Herodes at Kaypas.
      </p>
      <p>
        ...
        isang purpura, bilang pagpapalibhasa ng mga kaaway, nang sila ay nagsawa
        na ng ganitong mga parusa, ikaw ay dinala sa bundok ng Golgota tulad ng
        isang korderong walang sala.
      </p>
      <p>
      ...
      <p>
        Papaging dapatin mo po siya sa Iyong walang hanggang kaharian at ibilang
        sa pulutong ng mga banal, Ikaw na nabubuhay at naghahari ng kasama ng
        Ama at ng Espiritu Santo sa lahat ng panahon. Siya Nawa.
      </p>
      <p className="text-center">
        <b>(AWIT)</b>
      </p>
